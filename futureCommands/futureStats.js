...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addSubcommand(subcommand =>
			...
			.setDescription('Get a user\'s stats with their discord name')
			.addUserOption(option =>
				option.setName('discord')
				.setDescription('Input the discord name.')
				.setRequired(true))),
	async execute(interaction) {
		...
		if (subCommand == 'name'){
			...
			profile = await functions.getProfile('ID', '40008')
			color = await functions.getAura('ID', '40008')
		}
		if (profile == 'invalid'){
